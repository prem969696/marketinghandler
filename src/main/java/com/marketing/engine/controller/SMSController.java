...
@RestController
@RequestMapping("/api")
@Api(value = "Email API", description = "M related operations")
public class SMSController
{
    ...
    public ResponseEntity<String> saveProduct(@RequestBody Product product) {
        ...
        return new ResponseEntity("SMS saved successfully", OK);
    }
    ...
    public ResponseEntity<String> updateProduct(@PathVariable Integer id, @RequestBody Product product) {
        ...
        return new ResponseEntity("SMS updated successfully", OK);
    }
    ...
    public ResponseEntity<String> deleteProductById(@PathVariable Integer id) {
        ...
        return new ResponseEntity("SMS deleted successfully", OK);
